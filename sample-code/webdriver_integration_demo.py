...
# Be sure to configure SikuliDriverServer to use that folder for images by name

# start up both Firefox & SikuliDriver for demo
browser = webdriver.Firefox()
Sikuli_driver = webdriver.Remote( command_executor='http://127.0.0.1:4723/wd/hub', desired_capabilities={'browserName':'Sikuli'})
